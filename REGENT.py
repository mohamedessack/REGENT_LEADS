...
unfiltereddf1 = df[~ df['UTM Campaign'].str.contains(validation, case= False,na=False) & df['UTM Medium'].str.contains(validation, case= False,na=False) & df['UTM Source'].str.contains(validation1, case= False,na=False)]
